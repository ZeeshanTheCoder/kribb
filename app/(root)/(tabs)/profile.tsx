  ...
  const handleUpdateProfileImage = async () => {
    try {
      ...
      if (!permission.granted) {
        Alert.alert("Permission Denied", "Please allow access to your media library to update your profile picture.");
      }
      ...
      Alert.alert("Profile Updated", "Your profile picture updated successfully.");
    ...
    <SafeAreaView className="flex-1 bg-white" >
      ...
      <View className="px-6 gap-2">
        ...
        <MenuItem
          ...
          onPress={() =>
            Linking.openURL(
              "mailto:zeeshanthecoder@gmail.com?subject=Help%20%26%20Support%20-%20Kribb%20App"
            )
          }
        />
      </View>
