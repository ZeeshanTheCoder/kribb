...
export default function FilterModal({
    ...
    const [localMin, setLocalMin] = React.useState<string>(minPrice ? minPrice.toString() : '');
    const [localMax, setLocalMax] = React.useState<string>(maxPrice ? maxPrice.toString() : '');
